export const projects = {
  ...
  'order-module': {
    ...
    levelIds: [11, 12, 13, 14, 51, 15, 50, 43, 49, 44],
    days: [
      ...
      { levelId: 51, label: 'Day 5', title: '灰度异常拍板' },
      { levelId: 15, label: 'Day 6', title: 'P0 事故复盘' },
      { levelId: 50, label: 'Day 7', title: '小事故复盘' },
      { levelId: 43, label: 'Day 8', title: '订单状态机' },
      { levelId: 49, label: 'Day 9', title: '退款状态机' },
      { levelId: 44, label: 'Day 10', title: '订单接口断言' },
    ],
  },
  'onboard-week2': {
    id: 'onboard-week2',
