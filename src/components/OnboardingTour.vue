...
const steps = [
  {
    icon: '🎮',
    title: '欢迎来到测试人一生',
    body: '这是一款软件测试职场模拟闯关游戏。从备考、面试、笔试到入职，在 Jira、终端、企业微信等工具里完成测试任务，积累经验、提升职级。',
  },
  {
    icon: '🏠',
    title: '一套导航走全站',
  ...
  },
  {
    icon: '🎮',
    title: '上机实操 · 可选',
    body: '章节任务旁的「▶ App 复现」等按钮进入独立实操页（全屏 App/监控），不影响通关。关卡里也可点「可选 App 实操」跳转。',
  },
  {
    icon: '💻',
    title: '关卡工作台',
  ...
  },
  {
    icon: '🎬',
    title: '番外 & 每日特训',
    body: '番外推荐从「排查工具链」开始（Linux → SQL → Redis…），也有「测试思维选修」。通关第 5 关后解锁每日一题，连续完成可解锁成就。',
  },
  {
    icon: '💾',
    title: '记得备份存档',
