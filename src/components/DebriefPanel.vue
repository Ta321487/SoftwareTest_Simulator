...
onMounted(() => document.body.classList.add('debrief-open'))
onUnmounted(() => document.body.classList.remove('debrief-open'))
</script>
    ...
    <div class="debrief-overlay" role="dialog" aria-modal="true" aria-labelledby="debrief-title">
      <div class="debrief-panel">
        ...
        <div class="debrief-panel__body">
          ...
          <section
            v-if="
              handbookLinks?.terms?.length ||
              handbookLinks?.playbooks?.length ||
              handbookNoteLevelId
            "
